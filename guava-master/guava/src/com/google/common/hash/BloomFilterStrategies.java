...
enum BloomFilterStrategies implements BloomFilter.Strategy {
  ...
  MURMUR128_MITZ_64() {
    ...
    public <T> boolean put(
      ...
      for (int i = 0; i < numHashFunctions; i++) {
        ...
        // (combinedHash & Long.MAX_VALUE)使combinedHash为正数
  ...
  static final class LockFreeBitArray {
    ...
    final AtomicLongArray data; // long数组
    private final LongAddable bitCount; // 位数
    ...
    boolean set(long bitIndex) {
      ...
      // 这里将bitIndex右移6位，相当于除于64，算出long型数组的索引位置（bitIndex是总bit位数的索引）

...
public class ErrorContextTest {
  ...
  public void shouldShowProgressiveErrorContextBuilding() {
    ...
    System.out.println("reult" + context.toString());context.store();
    System.out.println("result" + ErrorContext.instance().resource("xxxxxxx.xml").toString());
    System.out.println("result" + context.recall().toString());
    context.reset();

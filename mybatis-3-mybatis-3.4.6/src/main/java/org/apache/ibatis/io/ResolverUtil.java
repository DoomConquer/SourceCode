 ...
 *
 * @author Tim Fennell
 * ResolverUtil用于查找路径下满足条件的类，条件通过实现Test接口的matches方法匹配
 */
public class ResolverUtil<T> {
   ...
   * 检验给定类是否包含AnnotatedWith构造时指定的注解
   */
   ...
   * 查找packageNames下类型类型为Class<?> parent的所有类，如果是接口，查找其实现类，结果通过resolver.getClasses()获取。
   *
   ...
   * 查找packageNames下包含annotation注解的所有类，结果通过resolver.getClasses()获取。
   *

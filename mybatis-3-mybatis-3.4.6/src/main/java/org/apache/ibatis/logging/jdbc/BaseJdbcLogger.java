...
public abstract class BaseJdbcLogger {
  ...
  protected static final Set<String> SET_METHODS = new HashSet<String>(); // 设置sql类型方法
  protected static final Set<String> EXECUTE_METHODS = new HashSet<String>();  // sql执行方法

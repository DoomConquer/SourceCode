 ...
 * 检查JDK是否支持某些特性（反射Parameter和时间Clock）
 */
public class Jdk {
   ...
   */
  public static final boolean parameterExists; // JDK是否支持反射Parameter

  static {
    boolean available = false;
    try {
      // 如果JDK不支持反射（java.lang.reflect.Parameter），parameterExists = false
  ...
  public static final boolean dateAndTimeApiExists; // JDK是否支持时间Clock

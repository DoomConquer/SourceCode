...
public final class ConnectStringParser {
    private static final int DEFAULT_PORT = 2181; // 客户端连接服务器默认端口

    private final String chrootPath; // 所有子结点根路径，例如127.0.0.1:3000,127.0.0.1:3001,127.0.0.1:3002/app/a，根路径为/app/a
    ...
    public ConnectStringParser(String connectString) {
        ...
        if (off >= 0) {
            ...
            if (chrootPath.length() == 1) { // 排除/
                this.chrootPath = null;
            } else {
                PathUtils.validatePath(chrootPath); // 验证path合法性

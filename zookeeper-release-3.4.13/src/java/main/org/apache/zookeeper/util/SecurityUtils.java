...
// 处理sasl工具类，提供SaslClient和SaslServer的创建
public final class SecurityUtils {
     ...
     * @param LOG logger
     * @param entity can be either zookeeper client or quorum learner 客户端或集群中learner
     *
    ...
    public static SaslClient createSaslClient(final Subject subject,
        ...
        // 如果getPrincipals为空，使用DIGEST-MD5方式，否则使用GSSAPI

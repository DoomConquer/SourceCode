...
public abstract class ServerCnxn implements Stats, Watcher {
    ...
    protected ArrayList<Id> authInfo = new ArrayList<Id>(); // 认证信息
     ...
     */
    boolean isOldClient = true; // 旧版客户端不能发送只读信息
    ...
    protected final static int confCmd =
        ByteBuffer.wrap("conf".getBytes()).getInt(); // getInt方法读取buffer中4个字节("conf".getBytes().length等于4)

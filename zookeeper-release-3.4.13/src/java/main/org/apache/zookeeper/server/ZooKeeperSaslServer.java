...
public class ZooKeeperSaslServer {
    public static final String LOGIN_CONTEXT_NAME_KEY = "zookeeper.sasl.serverconfig"; // 服务配置文件中sasl配置的名称
    public static final String DEFAULT_LOGIN_CONTEXT_NAME = "Server"; // 服务配置文件中sasl配置的默认名称

...
public class Request {
    ...
    private Object owner; // 请求关联的类（单机是ServerCnxn.me，集群是LearnerHandler），用于标识一个session所属

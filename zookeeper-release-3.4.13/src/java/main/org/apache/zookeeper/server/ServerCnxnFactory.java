...
public abstract class ServerCnxnFactory {
    ...
    public static final String ZOOKEEPER_SERVER_CNXN_FACTORY = "zookeeper.serverCnxnFactory"; // 设置ServerCnxnFactory的系统属性名称
    ...
    // 反射创建ServerCnxnFactory
    static public ServerCnxnFactory createFactory() throws IOException {
        String serverCnxnFactoryName =
            System.getProperty(ZOOKEEPER_SERVER_CNXN_FACTORY);
        if (serverCnxnFactoryName == null) { // 默认使用NIOServerCnxnFactory

...
public class Environment {
    public static final String JAAS_CONF_KEY = "java.security.auth.login.config"; // jaas配置文件路径
    ...
    public static List<Entry> list() {
        ...
        try {
            put(l, "host.name",
                InetAddress.getLocalHost().getCanonicalHostName()); // 主机名
        ...
        put(l, "java.vendor",
                System.getProperty("java.vendor", "<NA>")); // java供应商，Oracle Corporation
        put(l, "java.home",

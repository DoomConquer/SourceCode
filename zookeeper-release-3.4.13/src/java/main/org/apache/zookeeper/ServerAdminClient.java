...
public class ServerAdminClient {
    ...
    // kill服务，该命令在服务端已经移除
    // we should just remove the kill command from the client port. Its a security risk
    // (though we do not have much security right now) to be able to kill the server from
    // a tcp port without any authentication.
